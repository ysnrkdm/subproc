...
class SimpleLearn:
    ...
    def learn_and_update(self, id, books):
        print books[0]
        last_turn = int(books[0]['turn'])
        last_board = board.Board()
        last_board.deserialize(books[0]['book'], books[0]['whosturn'], books[0]['turn'])
        ...
        # store parameter
        update_parameters(id, new_param)
    ...
    def learn(self, book, current_parameters):
